export const stories = [
    {
        ...
        author: "Grant Bartel",
        category: "bitcoin",
        authorhandle: "@grantbartel",
        authorImg: "https://hackernoon.com/_next/image?url=https%3A%2F%2Flh3.googleusercontent.com%2Fa-%2FAOh14GiH8zGG5V5_6kvbvOyfcl2HN-rlXYpoquhhuk0M%3Ds96-c&w=1920&q=75",
        mainArticle: [
        ...
        subArticles: [
            {
                title: 'How Bitcoin and Gold are “The Same”',
                articles: [
                    ...
                    ["quote", "I buy Bitcoin for the same reason I buy gold: I don't save dollars. Why would I save something that can be printed? -- Robert Kiyosaki"],
                    ...
                    ["image", "https://hackernoon.com/_next/image?url=https%3A%2F%2Fcdn.hackernoon.com%2Fimages%2Fr1gGZuNNzjc0wNAM0O1SLicFdny2-ulo2dj8.jpeg&w=1920&q=75", "Visual Capitalist"],
            ...
            {
                title: 'The Primary Differences Between Bitcoin and Gold',
                articles: [
    ...
    },
    {
        ...
        authorhandle: "@jtruong",
        authorImg: "https://hackernoon.com/_next/image?url=https%3A%2F%2Fcdn.hackernoon.com%2Fimages%2FxwRTMTtsfYNZdN4zVqQuYZcuZrs1-ov029px.jpeg&w=1080&q=75",
        mainArticle: [
        ...
        subArticles: [
            {
                ...
                articles: [
                    ...
                    ["Do whatever you like on the phone, Download third-party applications outside of the App Store,  Unlock carrier restrictions, meaning you do not need to stick with AT&T as that is what Apple wants users to have as their carrier,  costomize and personalize your phone to your liking"],
                    ["Jailbreaking Risks"],
                    ["image", "https://hackernoon.com/_next/image?url=https%3A%2F%2Fcdn.hackernoon.com%2Fimages%2FxwRTMTtsfYNZdN4zVqQuYZcuZrs1-n3p835un.jpeg&w=1920&q=75", "Visual Capitalist"],
                    ["Although there are many things you can do with a jailbroken phone, there are some risks you may come across, including: Malware Installation, Priacy exposure, Fragile system"],
                ]
            },
            {
                title: 'How does Jailbreaking work?',
                articles: [
    ...
    },
    {
        ...
        authorhandle: "@phillftw",
        authorImg: "https://hackernoon.com/_next/image?url=https%3A%2F%2Fcdn.hackernoon.com%2Fimages%2Fy5rdAqC8eIPuI2WU4jkMQJIBJIm2-cf037vl.jpeg&w=1080&q=75",
        mainArticle: [],
        subArticles: [
            {
                title: 'So that’s a pretty loaded headline, right?  Clickbait at its finest, but there’s actually some substance to the hyperbole.',
                articles: [
                    ...
                    ["image", "https://cdn.hackernoon.com/images/y5rdAqC8eIPuI2WU4jkMQJIBJIm2-7323x37sw.png", "Visual Capitalist"],
                    ...
                    ["image", "https://cdn.hackernoon.com/images/y5rdAqC8eIPuI2WU4jkMQJIBJIm2-0wz937a6.png", "Visual Capitalist"],
            ...
            {
                title: 'Game Programming Simplified',
                articles: [
                    ...
                    ["image", "https://cdn.hackernoon.com/images/y5rdAqC8eIPuI2WU4jkMQJIBJIm2-6510e37qb.png", "Visual Capitalist"],
    ...
    },
    {
        ...
        author: "Mickey Maler",
        category: "blockchain",
        authorhandle: "@mickey-maler",
        authorImg: "https://hackernoon.com/_next/image?url=https%3A%2F%2Fcdn.hackernoon.com%2Fimages%2Favatars%2Fvw5cWXAztCZm8AiOqaVsrBthJFl2.jpg&w=1080&q=75",
        mainArticle: [
        ...
        subArticles: [
            {
                title: 'What is Under the Hood of a Bitcoin Block?',
                articles: [
                    ...
                    ["quote", '“At its core, the blockchain is a technology that permanently records transactions in a way that cannot be later erased but can only be sequentially updated, in essence keeping a never-ending historical trail. This seemingly simple functional description has gargantuan implications. It is making us rethink the old ways of creating transactions, storing data, and moving assets, and that’s only the beginning.” - WILLIAM MOUGAYAR, THE BUSINESS BLOCKCHAIN'],
                ]
            },
            {
                title: 'Exploring the Bitcoin Blockchain',
                articles: [
                    ...
                    ["image", "https://hackernoon.com/_next/image?url=https%3A%2F%2Fcdn.hackernoon.com%2Fimages%2Fvw5cWXAztCZm8AiOqaVsrBthJFl2-ap603aje.jpeg&w=1920&q=75", "Visual Capitalist"],
                    ["3. In the Recent block section on the right, click the top-most block in the Block height column."],
                    ["image", "https://hackernoon.com/_next/image?url=https%3A%2F%2Fcdn.hackernoon.com%2Fimages%2Fvw5cWXAztCZm8AiOqaVsrBthJFl2-tw6p3ayq.jpeg&w=1920&q=75", "Visual Capitalist"],
                    ["4. Blockchain explorers like the one we are using are really handy when tracking transactions or proving a transaction was sent. To use this explorer for tracking, insert the transaction number (generated by the sender) to the search bar in the top right."],
                ]
            }
        ]
    ...
    },
    {
        ...
        author: "Sarath C P",
        category: "edtech",
        authorhandle: "@sarathcp92",
        authorImg: "https://hackernoon.com/_next/image?url=https%3A%2F%2Fcdn.hackernoon.com%2Fimages%2Favatars%2FuJdCz5UU86XmC8QthQV4ex8gZE52.jpg&w=1080&q=75",
        mainArticle: [
        ...
        subArticles: [
            ...
            {
                title: 'What is an EdTech Unicorn?',
                articles: [
    ...
    },
    {
        ...
        category: "slogging",
        authorhandle: "@Limarc",
        authorImg: "https://hackernoon.com/_next/image?url=https%3A%2F%2Ffirebasestorage.googleapis.com%2Fv0%2Fb%2Fhackernoon-app.appspot.com%2Fo%2Fimages%252FugoTV1vwcgR4mN8MMDUUN4vt6p02-rx03uom.gif%3Falt%3Dmedia%26token%3Dd49c7e7d-e404-4324-bfaa-ba12837f7401&w=1080&q=75",
        mainArticle: [
        ...
        subArticles: [
            {
                title: 'Create a TL;DR Example',
                articles: [
                    ["This Slogging thread by Limarc Ambalina and Jeferson Borba occurred in slogging's official #software-development channel, and has been edited for readability."],
                    ["image", "https://hackernoon.com/_next/image?url=https%3A%2F%2Fstorage.googleapis.com%2Fhackernoon%2Fimages%2F%2Ffiles-pri%2FT01CVME82VC-F02D0DZ50M8%2Fimage.png&w=1920&q=75", "Visual Capitalist"],
